...
$config = array(
    ...
    |
    */
    'base_url' => rtrim(dirname($_SERVER["SCRIPT_NAME"],4),"/\\"),//((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] == "on") ? "https" : "http"). "://". @$_SERVER['HTTP_HOST']."/".rtrim(dirname($_SERVER["SCRIPT_NAME"],4),"/\\")."/",
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    |
    */
    'thumbs_base_path' => '../../../assets/images/',
    ...
    |
    */
    'thumbs_upload_dir' => '/assets/images/',
